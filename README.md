...
Legacy pywebview path пока сохранён только как explicit fallback на период cutover.
...
- Legacy Windows launcher через `src/botik/windows_entry.py` сохранён только как fallback.
