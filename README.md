...
Legacy pywebview/PyInstaller path retired as a supported operator and packaging path. Internal legacy modules remain in the repository only for controlled compatibility/test cleanup.
