...
- Primary desktop GUI: `pwsh ./scripts/run-primary-desktop.ps1`
- Primary packaged desktop shell: `apps/desktop`
- Legacy GUI modules under `src/botik/gui/app.py` and `src/botik/windows_entry.py` remain only for compatibility/test cleanup and are not the current product path.
